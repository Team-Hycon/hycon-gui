export default {
    ...
    "alert-complete-claim": "Your claim has been submitted. Thank you.",
    ...
    "attention-change-tx": "  The transaction in progress will be modified. Successfully modifying the transaction requires setting a higher transaction fee than the previous transaction fee. Your transaction will not change if a block containing the previous transaction is published before the modified transaction is broadcasted in the network.\n\n  Have you read the above and do you want to proceed?",
