                ...
                {!this.state.loggedIn ?
                                    ...
                                    <Grid container style={styles.modal.innerpadding}>
                                        <Grid item xs={12}>
                                            <Typography component="p" style={styles.typography.link}>
                                                {this.props.language["2fa-prompt"]}
                                        </Typography>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <FormControl style={styles.formField}>
                    ...
                    <CardContent style={{ width: "100%" }}>
                        <Grid container spacing={8}>
                            ...
                            <input type="checkbox" checked={this.state.advanced} onChange={(event) => this.handleCheckbox(event)} /> &nbsp;{this.props.language["advanced-option"]}
                            {(this.state.advanced)
                                ? (<div>
